...
static var cube_textures = {
    ...
    "full_grass_cube_corner":
    preload("res://assets/full_grass_cube_corner.png"),
}
static var scatter_textures = {
    "dirt_cube_corner_boulder":
    preload("res://assets/dirt_cube_corner_boulder.png"),
    "grass_cube_corner_leaf":
    preload("res://assets/grass_cube_corner_leaf.png"),
...
static var entity_textures = {"guydude": preload("res://assets/guydude.png")}
